...
87 × 2^3 = 696 and stores the result in w0. Then it stores 232 at offset 28 and then loads 232 and the input argument and subtracts the input argument from 232.
